...
const FONT_SIZE = 15
  ...
  stylesheet.textbox.normal.backgroundColor= '#000';
  stylesheet.textbox.normal.borderRadius= 25;
  stylesheet.textbox.normal.borderColor= COLOR_ORANGE;
  ...
  stylesheet.dateValue.normal.color= '#fff';
  stylesheet.dateValue.normal.paddingLeft= 15;
  stylesheet.dateValue.normal.fontSize= FONT_SIZE;
  stylesheet.dateValue.normal.backgroundColor= '#000';
  stylesheet.dateValue.normal.borderRadius= 25;
  stylesheet.dateValue.normal.borderColor= COLOR_ORANGE;
  stylesheet.dateValue.normal.borderWidth= 1;
  stylesheet.dateValue.normal.marginTop= 10;
  ...
  stylesheet.controlLabel.normal.color = COLOR_TEXT_GREY_LIGHT;
